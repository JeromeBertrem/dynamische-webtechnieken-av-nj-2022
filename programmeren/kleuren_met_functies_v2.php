...
function kleurenOpties($select_naam, $kleuren_opties) {
    $geselecteerde_kleur = $_POST[$select_naam];
        ...
        <ul>
            <li>Voorgrond keur 
                <select name="voorgrond_kleur">
                    <option></option>                                      
                    <?php echo kleurenOpties('voorgrond_kleur', $kleuren_opties); ?>
                </select>
            </li>
            <li>Achtergrond keur 
                <select name="achtergrond_kleur">
                    <option></option>
                    <?php echo kleurenOpties('achtergrond_kleur', $kleuren_opties); ?>
                </select>
            </li>
        </ul>
